// @mapbox/mapbox-gl-geocoder@5.0.3 downloaded from https://ga.jspm.io/npm:@mapbox/mapbox-gl-geocoder@5.0.3/lib/index.js
 ...
 * @private
 */function MapboxEventManager$1(t){this.origin=t.origin||"https://api.mapbox.com";this.endpoint="events/v2";this.access_token=t.accessToken;this.version="0.3.0";this.pluginSessionID=this.generateSessionID();this.sessionIncrementer=0;this.userAgent=this.getUserAgent();this.options=t;this.send=this.send.bind(this);this.countries=t.countries?t.countries.split(","):null;this.types=t.types?t.types.split(","):null;this.bbox=t.bbox?t.bbox:null;this.language=t.language?t.language.split(","):null;this.limit=t.limit?+t.limit:null;this.locale=navigator.language||null;this.enableEventLogging=this.shouldEnableLogging(t);this.eventQueue=new Array;this.flushInterval=t.flushInterval||1e3;this.maxQueueSize=t.maxQueueSize||100;this.timer=this.flushInterval?setTimeout(this.flush.bind(this),this.flushInterval):null;this.lastSentInput="";this.lastSentIndex=0}MapboxEventManager$1.prototype={
/**
     ...
     * @returns {Promise}
     */
select:function(t,e){var i=this.getEventPayload("search.select",e,{selectedFeature:t});if(i&&(i.resultIndex!==this.lastSentIndex||i.queryString!==this.lastSentInput)&&i.resultIndex!=-1){this.lastSentIndex=i.resultIndex;this.lastSentInput=i.queryString;return this.push(i)}},
/**
     ...
     * @returns {Promise}
     */
start:function(t){var e=this.getEventPayload("search.start",t);if(e)return this.push(e)},
/**
   ...
   * 
   */
keyevent:function(t,e){if(t.key&&!t.metaKey&&[9,27,37,39,13,38,40].indexOf(t.keyCode)===-1){var i=this.getEventPayload("search.keystroke",e,{key:t.key});if(i)return this.push(i)}},
/**
...
/**
   ...
   */
getEventPayload:function(t,e,i={}){if(t==="search.select"&&!i.selectedFeature||t==="search.keystroke"&&!i.key)return null;var o;if(e.options.proximity)if(typeof e.options.proximity==="object")o=[e.options.proximity.longitude,e.options.proximity.latitude];else if(e.options.proximity==="ip"){var n=e._headers?e._headers["ip-proximity"]:null;o=n&&typeof n==="string"?n.split(",").map(parseFloat):[999,999]}else o=e.options.proximity;else o=null;var s=e._map?e._map.getZoom():void 0;var r={event:t,version:this.getEventSchemaVersion(t),created:+new Date,sessionIdentifier:this.getSessionId(),country:this.countries,userAgent:this.userAgent,language:this.language,bbox:this.bbox,types:this.types,endpoint:"mapbox.places",autocomplete:e.options.autocomplete,fuzzyMatch:e.options.fuzzyMatch,proximity:o,limit:e.options.limit,routing:e.options.routing,worldview:e.options.worldview,mapZoom:s,keyboardLocale:this.locale};t==="search.select"?r.queryString=e.inputString:t!="search.select"&&e._inputEl?r.queryString=e._inputEl.value:r.queryString=e.inputString;["search.keystroke","search.select"].includes(t)&&(r.path="geocoding/v5/mapbox.places");if(t==="search.keystroke"&&i.key)r.lastAction=i.key;else if(t==="search.select"&&i.selectedFeature){var a=i.selectedFeature;var l=this.getSelectedIndex(a,e);r.resultIndex=l;r.resultPlaceName=a.place_name;r.resultId=a.id;a.properties&&(r.resultMapboxId=a.properties.mapbox_id);if(e._typeahead){var h=e._typeahead.data;if(h&&h.length>0){r.suggestionIds=this.getSuggestionIds(h);r.suggestionNames=this.getSuggestionNames(h);r.suggestionTypes=this.getSuggestionTypes(h);r.suggestionSources=this.getSuggestionSources(h)}}}return this.validatePayload(r)?r:null},
/**
...
/**
   ...
   * @private
   */
handleError:function(t,e){if(e)return e(t)},generateSessionID:function(){return d()},
/**
   * Get the a unique session ID for the current plugin session and increment the session counter.
   *
   * @returns {String} The session ID
   */
getSessionId:function(){return this.pluginSessionID+"."+this.sessionIncrementer},getUserAgent:function(){return"mapbox-gl-geocoder."+this.version+"."+navigator.userAgent},
/**
     ...
     */
getSelectedIndex:function(t,e){if(e._typeahead){var i=e._typeahead.data;var o=t.id;var n=i.map((function(t){return t.id}));var s=n.indexOf(o);return s}},getSuggestionIds:function(t){return t.map((function(t){return t.properties?t.properties.mapbox_id||"":t.id||""}))},getSuggestionNames:function(t){return t.map((function(t){return t.place_name||""}))},getSuggestionTypes:function(t){return t.map((function(t){return t.place_type&&Array.isArray(t.place_type)&&t.place_type[0]||""}))},getSuggestionSources:function(t){return t.map((function(t){return t._source||""}))},
/**
   ...
   * @returns 
   */
getEventSchemaVersion:function(t){return["search.keystroke","search.select"].includes(t)?"2.2":"2.0"},
/**
   ...
   * @returns 
   */
validatePayload:function(t){if(!t||!t.event)return false;var e=["event","created","sessionIdentifier","queryString"];var i=["event","created","sessionIdentifier","queryString","lastAction"];var o=["event","created","sessionIdentifier","queryString","resultIndex","path","suggestionIds"];var n=t.event;return n==="search.start"?this.objectHasRequiredProps(t,e):n==="search.keystroke"?this.objectHasRequiredProps(t,i):n!=="search.select"||this.objectHasRequiredProps(t,o)},
/**
   ...
   * @returns 
   */
objectHasRequiredProps:function(t,e){return e.every((function(e){return e==="queryString"?typeof t[e]==="string"&&t[e].length>0:t[e]!==void 0}))},shouldEnableLogging:function(t){return t.enableEventLogging!==false&&(!t.origin||t.origin==="https://api.mapbox.com")},flush:function(){if(this.eventQueue.length>0){this.send(this.eventQueue);this.eventQueue=new Array}this.timer&&clearTimeout(this.timer);this.flushInterval&&(this.timer=setTimeout(this.flush.bind(this),this.flushInterval))},
/**
 ...
 * @param {object} feature 
 * @returns {object}
 */function getAddressInfo(t){const e=t.address||"";const i=t.text||"";const o=t.place_name||"";const n=o.split(",")[0];const s={address:n,houseNumber:e,street:i,placeName:o};t.context.forEach((function(t){const e=t.id.split(".")[0];s[e]=t.text}));return s}const b=/^[ ]*(-?\d{1,3}(\.\d{0,256})?)[, ]+(-?\d{1,3}(\.\d{0,256})?)[ ]*$/;y={transformFeatureToGeolocationText:transformFeatureToGeolocationText,getAddressInfo:getAddressInfo,REVERSE_GEOCODE_COORD_RGX:b};var E=y;var x=t;try{"default"in t&&(x=t.default)}catch(t){}var k=e;try{"default"in e&&(k=e.default)}catch(t){}var w=i;try{"default"in i&&(w=i.default)}catch(t){}var S=o;try{"default"in o&&(S=o.default)}catch(t){}var L=n;try{"default"in n&&(L=n.default)}catch(t){}var C=s;try{"default"in s&&(C=s.default)}catch(t){}var I=a;try{"default"in a&&(I=a.default)}catch(t){}var M={};var T=x;var A=k;var R=w;var B=S.EventEmitter;var G=h;var P=L;var O=C;var z=p;var q=m;var F=I;var N=v;var D=E;const V={FORWARD:0,LOCAL:1,REVERSE:2};function getFooterNode(){var t=document.createElement("div");t.className="mapboxgl-ctrl-geocoder--powered-by";t.innerHTML='<a href="https://www.mapbox.com/search-service" target="_blank">Powered by Mapbox</a>';return t}
/**
...
/**
   ...
   *
   */
_clear:function(t){t&&t.preventDefault();this._inputEl.value="";this._typeahead.selected=null;this._typeahead.clear();this.eventManager.sessionIncrementer++;this._onChange();this._hideClearButton();this._showGeolocateButton();this._removeMarker();this.lastSelected=null;this._eventEmitter.emit("clear");this.fresh=true},
/**
...
/**
   ...
   * @private
   */
_getPlaceholderText:function(){if(this.options.placeholder)return this.options.placeholder;if(this.options.language){var t=this.options.language.split(",")[0];var e=F.language(t);var i=q.placeholder[e];if(i)return i}return"Search"},
/**
   * Set input
   * @param {string} searchInput location name or other search input
...
/**
   ...
   * @returns {MapboxGeocoder} this
   */
setOrigin:function(t){this.options.origin=t;this.geocoderService=O(P({accessToken:this.options.accessToken,origin:this.options.origin}));return this},
/**
...
/**
   ...
   * @returns {MapboxGeocoder} this
   */
setAccessToken:function(t){this.options.accessToken=t;this.geocoderService=O(P({accessToken:this.options.accessToken,origin:this.options.origin}));return this},
/**
...
/**
   ...
   * @returns {MapboxGeocoder} this
   */
_handleMarker:function(t){if(this._map){this._removeMarker();var e={color:"#4668F2"};var i=R({},e,this.options.marker);this.mapMarker=new this._mapboxgl.Marker(i);t.center?this.mapMarker.setLngLat(t.center).addTo(this._map):t.geometry&&t.geometry.type&&t.geometry.type==="Point"&&t.geometry.coordinates&&this.mapMarker.setLngLat(t.geometry.coordinates).addTo(this._map);return this}},_removeMarker:function(){if(this.mapMarker){this.mapMarker.remove();this.mapMarker=null}},
/**
