// #lib/client.js@0.16.1 downloaded from https://ga.jspm.io/npm:@mapbox/mapbox-sdk@0.16.1/lib/browser/browser-client.js

import{_ as e,a as r}from"../../_/ciiXFMds.js";import{_ as t,a as n}from"../../_/BOlvsJFc.js";import"@mapbox/parse-mapbox-token";import"xtend";import"eventemitter3";var s={};function parseSingleHeader(e){var r=e.indexOf(":");var t=e.substring(0,r).trim().toLowerCase();var n=e.substring(r+1).trim();return{name:t,value:n}}
/**
 ...
 * @returns {MapiClient}
 */function createBrowserClient(e){return new BrowserClient(e)}l=createBrowserClient;var m=l;export{m as default};
